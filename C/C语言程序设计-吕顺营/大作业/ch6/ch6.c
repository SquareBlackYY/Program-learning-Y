...
void showCh6Menu()
{
    ...
    printf("0-返回上级菜单\n");
    printf("1-第2题 一些计算\n");
    printf("2-第3题 爱因斯坦数学题\n");
    printf("3-第4题 输入一些数的平方和立方\n");
    printf("4-第5题 华氏度与摄氏度转换\n");
    printf("5-第6题 计算本金\n");
    printf("6-第7题 计算产值翻番所需时间\n");
    printf("7-第8题 计算π的值\n");
    printf("8-第9题 计算e的值\n");
    printf("9-第10题 输出水仙花数\n");
    printf("10-第11题 求m的整数解\n");
    printf("11-第12题 求和（1）\n");
    printf("12-第13题 求和（2）\n");
    printf("13-第14题 马克思の趣味数学题\n");
    printf("14-第15题 鸡兔同笼问题\n");
    printf("15-第16题 百鸡问题\n");
    printf("16-第17题 兑换方案问题\n");
    printf("17-第18题 输出九九乘法表\n");
    printf("18-第19题 陌生人の换钱计划\n");
    printf("19-第20题 三个谜语人\n");
    printf("20-第21题 军舰鸣放礼炮计划\n");
    printf("21-第22题 国王の许诺\n");
    printf("********************\n");
}
