...
#define NumOfReform 3              // 默认单题允许重做次数
...
void ch7_14()
{
    int x, y, UpperLimit, i, Reform, Right, Answer, Remainder, TrueAnswer, OperatorNum, CheckAnswer, CorrectTips, WrongTips;
