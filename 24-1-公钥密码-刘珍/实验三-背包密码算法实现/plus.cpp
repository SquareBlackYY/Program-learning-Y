...
public:
    // 初始化
    MH_Knapsack_Key(const std::vector<mpz_class> Sequence_SI = std::vector<mpz_class>(), mpz_class k = 0, mpz_class t = 0)
    {
        srand(time(0));
    ...
    MH_Knapsack_Key(const int Knapsack_Size = 0)
    {
        srand(time(0));
...
int main()
{
    ...
    MH_Knapsack_Key key1({2, 3, 6, 13, 27, 52}, 105, 31);
